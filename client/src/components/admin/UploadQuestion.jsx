      ...
      <form onSubmit={handleSubmit} className="form-card upload-form-card" noValidate>
        ...
        <div className="upload-grid-two">
          <div className="form-group">
            ...
            <select className="form-control" value={category} onChange={handleCategoryChange} required>
              ...
              {Object.keys(CATEGORIES).filter((cat) => cat !== 'Standalone NGN' && cat !== 'Unfolding NGN').map((cat) => (
        ...
        <div className="form-group">
          ...
          {rationale.trim() && (
            ...
            >
              <div style={{ fontSize: '0.7rem', color: '#16a34a', fontWeight: 600, marginBottom: '6px', textTransform: 'uppercase', letterSpacing: '0.5px' }}>
